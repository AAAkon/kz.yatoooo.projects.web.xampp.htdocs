<footer class="container-fluids bg-4 text-center">
  ...
  <div class="follow col-md-6">
    ...
    <ul class="social-network social-circle">
        <li><a href="https://www.rss.com/" class="icon icoRss" title="Rss"><i class="fa fa-rss"></i></a></li>
        <li><a href="https://web.facebook.com/" class="icon icoFacebook" title="Facebook"><i class="fa fa-facebook"></i></a></li>
        <li><a href="https://twitter.com/" class="icon icoTwitter" title="Twitter"><i class="fa fa-twitter"></i></a></li>
        <li><a href="https://www.google.kz/" class="icon icoGoogle" title="Google +"><i class="fa fa-google-plus"></i></a></li>
        <li><a href="https://www.linkedin.com/" class="icon icoLinkedin" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
